...
func TestToStringMapIntE(t *testing.T) {
	tests := []struct {
		...
		{map[string]float64{"v1": 8.22, "v2": 43.32}, map[string]int{"v1": 8, "v2": 43}, false},
...
func TestToStringMapInt64E(t *testing.T) {
	tests := []struct {
		...
		{map[string]float64{"v1": 8.22, "v2": 43.32}, map[string]int64{"v1": 8, "v2": 43}, false},
...
func TestToStringSliceE(t *testing.T) {
	tests := []struct {
		...
		{[]float64{1.01, 2.01}, []string{"1.01", "2.01"}, false},
